...
export class SessionController {
    ...
    @ApiQuery({ name: 'sort', required: false, example: 'latest', description: 'latest | mentor | rating' })
    @ApiQuery({ name: 'category', required: false, description: '카테고리 이름 (선택)' })
    @ApiResponse({
        status: 200,
